...
| 05 | [FEAT_05_BEP_XU_LY_MON.md](./FEAT_05_BEP_XU_LY_MON.md) | Bếp xử lý món | Sprint 4 | ✅ Hoàn thành |
| 06 | [FEAT_06_THANH_TOAN_HOA_DON.md](./FEAT_06_THANH_TOAN_HOA_DON.md) | Thanh toán / Hoá đơn | Sprint 4/5 | ✅ Hoàn thành |
| 07 | [FEAT_07_DAT_BAN_TRUOC.md](./FEAT_07_DAT_BAN_TRUOC.md) | Đặt bàn trước | Sprint 5 | ✅ Hoàn thành |
| 08 | [FEAT_08_BAO_CAO_DOANH_THU.md](./FEAT_08_BAO_CAO_DOANH_THU.md) | Báo cáo Doanh thu | Sprint 5 | ✅ Hoàn thành |
| 09 | [FEAT_09_KHO_NGUYEN_LIEU.md](./FEAT_09_KHO_NGUYEN_LIEU.md) | Kho Nguyên liệu | Sprint 6 | ✅ Hoàn thành |
| 10 | [FEAT_10_NHAN_VIEN_TAI_KHOAN.md](./FEAT_10_NHAN_VIEN_TAI_KHOAN.md) | Nhân viên / Tài khoản | Sprint 6 | ✅ Hoàn thành |
| 11 | [FEAT_11_AUDIT_LOG.md](./FEAT_11_AUDIT_LOG.md) | Audit Log & Log theo dõi | Cross-sprint | ✅ Hoàn thành |
| 12 | [FEAT_12_ERROR_HANDLING_SECURITY.md](./FEAT_12_ERROR_HANDLING_SECURITY.md) | Xử lý lỗi & Bảo mật | Cross-sprint | ✅ Hoàn thành |
| 13 | [FEAT_13_CHECKLIST_VERIFY_FULLSTACK.md](./FEAT_13_CHECKLIST_VERIFY_FULLSTACK.md) | Checklist Verify Toàn bộ Hệ thống | Sau Sprint 6 | ✅ Hoàn thành |
...
Sprint 4 ── FEAT_05 (Bếp) + FEAT_06 (Thanh toán) ──── ✅
Sprint 5 ── FEAT_07 (Đặt bàn) + FEAT_08 (Báo cáo) ── ✅
Sprint 6 ── FEAT_09 (Kho) + FEAT_10 (Nhân viên) ───── ✅
Cross ──── FEAT_11 (Audit Log) + FEAT_12 (Error/Security) ── ✅
Verify ── FEAT_13 (Checklist toàn hệ thống) ────────── ✅
```
